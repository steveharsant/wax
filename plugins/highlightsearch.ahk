; Minor modification from: https://github.com/GorvGoyl/Autohotkey-Scripts-Windows/blob/master/look_up.ahk

; win+g : open highlighted text in browser and do google search / visit site (if it's url)
